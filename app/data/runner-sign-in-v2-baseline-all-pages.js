const { SEED } = require("../lib/titan-mvp-1.2/runner-sign-in-v2-baseline-choose-journeys");
const { STATIC_BASE } = require("./advanced-settings-static");

function buildRunnerSignInV2BaselineAllPagesSections(urls, { formKey, applicationId, reviewToken, unexpectedPages }) {
  ...
  const checker = (path) =>
    `/runner-sign-in-v2-baseline/checker/${path}?token=${enc(reviewToken)}&prototype=1&allowApplicant=1`;
  ...
  const copyManageUrl = `/runner-sign-in-v2-baseline/forms/${enc(copyFormKey)}/${enc(copyApplicationId)}/manage`;
  ...
  return [
    {
      heading: "Prototype",
      links: [
        { text: "Start page", href: "/runner-sign-in-v2-baseline/start-page" },
        { text: "Choose a journey", href: "/runner-sign-in-v2-baseline/choose-journey" },
        { text: "All pages", href: urls.allPages || "/runner-sign-in-v2-baseline/all-pages" },
        { text: "All pages (static)", href: urls.allPagesStatic || "/runner-sign-in-v2-baseline/all-pages/static" },
        { text: "Journeys", href: "/runner-sign-in-v2-baseline/journeys" },
        { text: "Journey flowcharts", href: "/runner-sign-in-v2-baseline/journey-flowcharts" },
        { text: "Unexpected journeys", href: "/runner-sign-in-v2-baseline/unexpected-journeys" },
        { text: "Validation error messages", href: urls.errorMessages || "/runner-sign-in-v2-baseline/error-messages" },
      ],
    },
    {
    ...
    },
    {
      ...
      links: [
        ...
        },
        {
          ...
          href: `/runner-sign-in-v2-baseline/forms/${enc(copyFormKey)}/${enc(copyDraftId)}/ready-to-submit`,
        },
        {
          text: "Manage your form (after copy)",
          href: `/runner-sign-in-v2-baseline/forms/${enc(copyFormKey)}/${enc(copyDraftId)}/manage?cloned=1`,
        },
        {
          text: "Form submitted",
          href: `/runner-sign-in-v2-baseline/forms/${enc(copyFormKey)}/${enc(copyApplicationId)}/submitted`,
        },
        {
          text: "Form submitted confirmation email (copied answers)",
          href: copyEmailTriple("/runner-sign-in-v2-baseline/emails/form-submitted"),
        },
        {
          text: "Form submitted email – public view (copied answers)",
          href: copyEmailTriple("/runner-sign-in-v2-baseline/emails/form-submitted/public"),
        },
      ],
    },
    {
      ...
      links: [
        ...
        { text: "Your sign-in has been created", href: triple("/runner-sign-in-v2-baseline/create-sign-in/created", urls.manage) },
      ],
    },
    {
      heading: "Sign in",
      links: [
        ...
        { text: "Get security code", href: triple("/runner-sign-in-v2-baseline/sign-in/get-security-code", urls.manage) },
    ...
    },
    {
      ...
      links: [
        ...
        { text: "Check your phone (alternate)", href: triple("/runner-sign-in-v2-baseline/recover/check-mobile") },
    ...
    },
    {
      ...
      links: [
        ...
        { text: "Your progress has been saved", href: urls.saveExitCreated || "/runner-sign-in-v2-baseline/journeys/preview/save-exit-progress-saved" },
    ...
    },
    {
      ...
      links: [
        ...
        { text: "Invite a checker", href: urls.checkerInvite },
        {
          ...
          href: `/runner-sign-in-v2-baseline/forms/${enc(SEED.readyToInvite.formKey)}/${enc(SEED.readyToInvite.applicationId)}/checker/invite-sent?checkerEmail=checker@example.com`,
        },
        ...
        { text: "Check answers", href: checker("check-answers") },
        {
          ...
          href: `/runner-sign-in-v2-baseline/checker/view/organisation?token=${enc(reviewToken)}&prototype=1&allowApplicant=1`,
        },
    ...
    },
    {
      ...
      links: [
        ...
        { text: "Security code email", href: `/runner-sign-in-v2-baseline/emails/email-confirmation-code?${q}` },
        { text: "Sign-in created email", href: `/runner-sign-in-v2-baseline/emails/one-login-created?${q}&email=you@example.com` },
        { text: "Checker invite email", href: urls.emailCheckerInvite },
...
function buildRunnerSignInV2BaselineAllPagesStaticSections(urls, { unexpectedPages }) {
  const p = urls.preview || {};
  const preview = (slug) => `/runner-sign-in-v2-baseline/journeys/preview/${encodeURIComponent(slug)}`;
  ...
  return [
    {
      ...
      links: [
        { text: "Start page", href: "/runner-sign-in-v2-baseline/start-page" },
        { text: "Choose a journey", href: "/runner-sign-in-v2-baseline/choose-journey" },
        { text: "All pages (live links)", href: urls.allPages || "/runner-sign-in-v2-baseline/all-pages" },
        { text: "Journeys", href: "/runner-sign-in-v2-baseline/journeys" },
        { text: "Journey flowcharts", href: "/runner-sign-in-v2-baseline/journey-flowcharts" },
        { text: "Unexpected journeys", href: "/runner-sign-in-v2-baseline/unexpected-journeys" },
        { text: "Validation error messages", href: urls.errorMessages || "/runner-sign-in-v2-baseline/error-messages" },
...
module.exports = {
  buildRunnerSignInV2BaselineAllPagesSections,
  buildRunnerSignInV2BaselineAllPagesStaticSections,
};
