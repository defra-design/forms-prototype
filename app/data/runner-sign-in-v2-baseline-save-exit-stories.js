function errorRef(slug) {
  return `/runner-sign-in-v2-baseline/error-messages/${slug}`;
}
...
function preview(urls, slug) {
  ...
  return `/runner-sign-in-v2-baseline/journeys/preview/${encodeURIComponent(slug)}`;
}

function buildRunnerSignInV2BaselineSaveExitStories(urls) {
...
module.exports = { buildRunnerSignInV2BaselineSaveExitStories };
