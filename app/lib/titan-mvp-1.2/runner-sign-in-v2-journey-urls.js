function runnerSignInV2BuildJourneyUrls({
  ...
  return {
    ...
    createEmail: triple("/runner-sign-in-v2/sign-in/email", manageUrl),
    createCheckEmail: triple("/runner-sign-in-v2/sign-in/check-email", manageUrl),
    createMobile: triple("/runner-sign-in-v2/sign-in/mobile", manageUrl),
    createGetCode: triple("/runner-sign-in-v2/sign-in/get-security-code", manageUrl),
    ...
    signInMobile: triple("/runner-sign-in-v2/sign-in/mobile", manageUrl),
    signInGetCode: triple("/runner-sign-in-v2/sign-in/get-security-code", manageUrl),
    ...
    saveExitCreate: triple("/runner-sign-in-v2/sign-in/email", saveExitLeaveUrl),
    ...
    saveExitWithoutSignInCheckEmail: `/runner-sign-in-v2/sign-in/check-email?${queryOnly}&prototype=1`,
    saveExitCreated: triple("/runner-sign-in-v2/create-sign-in/created", saveExitLeaveUrl),
    createCheckEmailSaveExit: triple("/runner-sign-in-v2/sign-in/check-email", saveExitLeaveUrl),
    createMobileSaveExit: triple("/runner-sign-in-v2/sign-in/mobile", saveExitLeaveUrl),
    createGetCodeSaveExit: triple("/runner-sign-in-v2/sign-in/get-security-code", saveExitLeaveUrl),
    createCheckEmailSaveExitResend: `${triple("/runner-sign-in-v2/sign-in/check-email", saveExitLeaveUrl)}&resend=1`,
    ...
    preview: journeyPreviewPath
      ? {
          ...
          signInMobile: journeyPreviewPath("sign-in-mobile"),
          signInGetCode: journeyPreviewPath("sign-in-get-security-code"),
