...
function runnerSignInV2ChooseJourneyRadioItems(selected) {
  const items = [
    ...
    { divider: "or" },
    {
      ...
      hint: {
        text: "Open the runner sign-in v2 start page with seeded examples, prototype mode, and links to documentation.",
      },
...
function runnerSignInV2ChooseJourneyRedirect(
  journeyId,
  ...
  const formStart = (formKey, applicationId) =>
    `/runner-sign-in-v2/forms/${enc(formKey)}/${enc(applicationId)}/start-page`;
  ...
  switch (journeyId) {
    ...
    case "credential-recovery":
      return triple(
        "/runner-sign-in-v2/recover/phone",
    ...
    case "recover":
      return triple(
        "/runner-sign-in-v2/sign-in/email",
        SEED.inProgress.formKey,
        SEED.inProgress.applicationId,
        managePath(SEED.inProgress.formKey, SEED.inProgress.applicationId)
      );
    ...
    case "save-exit-unsigned":
      return "/runner-sign-in-v2/demo/save-and-exit/start-page";
    ...
    case "prototype-hub":
      return "/runner-sign-in-v2/start-page";
    default:
      return null;
  }
}
